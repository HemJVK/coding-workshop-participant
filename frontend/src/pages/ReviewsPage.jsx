          ...
          <Paper elevation={0} sx={{ border: '1px solid', borderColor: 'divider', borderRadius: 2, overflow: 'hidden' }}>
            <Table>
              <TableHead><TableRow>
                ...
                <TableCell>Strengths</TableCell>{canWrite && <TableCell align="right">Actions</TableCell>}
              </TableRow></TableHead>
              <TableBody>
                {reviews.map(r => (
                ...
                {!reviews.length && <TableRow><TableCell colSpan={canWrite ? 7 : 6} align="center" sx={{ py: 4, color: 'text.secondary' }}>No reviews found</TableCell></TableRow>}
              </TableBody>
            </Table>
          </Paper>
        )}
